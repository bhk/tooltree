...
function T.uriToString()
   local function e(o, s, h, p, v, a, f)
      eq(o, _U.uriToString{ scheme=s, authority=h, path=p, version=v, params=a, fragment=f})
   end
   e( "s://h/p@v", "s", "h", "p", "v")
   e( "s://h/",    "s", "h", "", false)
   e( "/abc#def",  nil,  nil, "/abc", nil, nil, "def")
...
function T.gen_and_parse()
   ...
   -- from table
   e("s://h/p@v?p;a=b", { scheme = "s", authority = "h", path = "/p",
   ...
   e("s://h/p@v?p;a=b", "/p?a=b;p", { scheme = "s", authority = "h", version = "v"})
