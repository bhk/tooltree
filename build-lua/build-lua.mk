...
_LuaEnv.luaExe       = $(lua-exports)/bin/lua
...
#
LuaRun.inherit  = LuaCmd LuaEnv Run
LuaExec.inherit = LuaCmd LuaEnv Exec
LuaTest.inherit = LuaCmd LuaEnv Test
...
_LuaCC.inherit  = CC
_LuaCC.includes = $(lua-exports)/src {inherit}
